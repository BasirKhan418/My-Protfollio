      ...
      <div className="mt-8 flex flex-wrap items-center gap-3">
        {product.liveUrl && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1 rounded-full transition bg-teal-700 text-white shadow-sm text-sm font-medium px-4 py-2 hover:bg-teal-600"
          >
            Live Preview
          </a>
        )}
        {product.githubUrl && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1 rounded-full transition border border-neutral-300 bg-white text-neutral-800 text-sm font-medium px-4 py-2 hover:bg-neutral-100"
          >
            GitHub Repository
          </a>
        )}
